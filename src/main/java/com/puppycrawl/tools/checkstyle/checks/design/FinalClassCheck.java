...
public class FinalClassCheck
    ...
    private void registerExtendedClass(String qualifiedClassName,
        ...
        if (superClassName != null) {
            final ToIntFunction<ClassDesc> nestedClassCountProvider =
                    classDesc -> CheckUtil.typeDeclarationNameMatchingCount(qualifiedClassName,
    ...
    private void registerAnonymousInnerClassToSuperClass(DetailAST literalNewAst,
        ...
        final ToIntFunction<ClassDesc> anonClassCountProvider =
                classDesc -> getAnonSuperTypeMatchingCount(outerTypeDeclName, classDesc.getQualifiedName());
