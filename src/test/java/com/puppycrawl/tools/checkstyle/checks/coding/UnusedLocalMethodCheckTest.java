...
public class UnusedLocalMethodCheckTest extends AbstractModuleTestSupport {
    ...
    public void unusedLocalMethod() throws Exception {
        verifyWithInlineConfigParser(getPath("InputUnusedLocalMethod.java"), new String[]{
    ...
    public void unusedLocalMethodChain() throws Exception {
        verifyWithInlineConfigParser(getPath("InputUnusedLocalMethodChain.java"), new String[]{
    ...
    public void unusedLocalMethodChainUnused() throws Exception {
        verifyWithInlineConfigParser(getPath("InputUnusedLocalMethodChainUnused.java"), new String[]{
    ...
    public void unusedLocalMethodMulti() throws Exception {
        verifyWithInlineConfigParser(getPath("InputUnusedLocalMethodMulti.java"), new String[]{
    ...
    public void unusedLocalMethodOnlyOnPrivateMethodScope() throws Exception {
        verifyWithInlineConfigParser(getPath("InputUnusedLocalMethodOnlyOnPrivateMethodScope.java"), new String[]{
    ...
    public void unusedLocalMethodOverload() throws Exception {
        verifyWithInlineConfigParser(getPath("InputUnusedLocalMethodOverload.java"), new String[]{
